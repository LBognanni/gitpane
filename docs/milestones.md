...
| M1-S2 — Preparation and memory | Not started | M1-S1 | Raw report with isolated CPU/allocation phases |
| M1-S3 — Rendering and interaction | Not started | M1-S1, M1-S2 | Headless current-viewer measurements |
